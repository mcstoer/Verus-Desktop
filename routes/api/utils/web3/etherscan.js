const { EtherscanProvider, Networkish, BlockTag } = require('ethers');

class HistorySupportingEtherscanProvider extends EtherscanProvider {
  /**
...
module.exports = {
  HistorySupportingEtherscanProvider
}